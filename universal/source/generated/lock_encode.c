		...
		zcbor_state_t *state, const struct get_entry_details_result *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 10) && (int_res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"index", tmp_str.len = sizeof("index") - 1, &tmp_str)))))
	...
	&& zcbor_present_encode(&((*input)._get_entry_details_result_max_present), (zcbor_encoder_t *)encode_repeated_get_entry_details_result_max, state, (&(*input)._get_entry_details_result_max))), ((zcbor_map_end_encode(state, 10)) && int_res)))));
		...
		zcbor_state_t *state, const struct get_entry_details *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 2) && (int_res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"method", tmp_str.len = sizeof("method") - 1, &tmp_str)))))
	...
	: false))))))
	&& zcbor_present_encode(&((*input)._get_entry_details_index_present), (zcbor_encoder_t *)encode_repeated_get_entry_details_index, state, (&(*input)._get_entry_details_index))), ((zcbor_map_end_encode(state, 2)) && int_res)))));
		...
		zcbor_state_t *state, const struct get_indices_result *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 3) && (int_res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"table_size", tmp_str.len = sizeof("table_size") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_encode(state, (&(*input)._get_indices_result_max_id))))), ((zcbor_map_end_encode(state, 3)) && int_res)))));
		...
		zcbor_state_t *state, const struct get_api_version_result *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 1) && (int_res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"api_version", tmp_str.len = sizeof("api_version") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input)._get_api_version_result_api_version))))), ((zcbor_map_end_encode(state, 1)) && int_res)))));
		...
		zcbor_state_t *state, const struct get_parameter_result *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 3) && (int_res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"r", tmp_str.len = sizeof("r") - 1, &tmp_str)))))
	...
	&& zcbor_present_encode(&((*input)._get_parameter_result_r1_present), (zcbor_encoder_t *)encode_repeated_get_parameter_result_r1, state, (&(*input)._get_parameter_result_r1))), ((zcbor_map_end_encode(state, 3)) && int_res)))));
