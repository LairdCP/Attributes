...
const struct attr_table_entry ATTR_TABLE[ATTR_TABLE_SIZE] = {
	...
	[70 ] = { 70 , RO_ATTRX(temperature_result_1)          , ATTR_TYPE_FLOAT         , 0x2   , av_float            , attr_prepare_temperature_result_1   , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[71 ] = { 71 , RO_ATTRX(temperature_result_2)          , ATTR_TYPE_FLOAT         , 0x2   , av_float            , attr_prepare_temperature_result_2   , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[72 ] = { 72 , RO_ATTRX(temperature_result_3)          , ATTR_TYPE_FLOAT         , 0x2   , av_float            , attr_prepare_temperature_result_3   , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[73 ] = { 73 , RO_ATTRX(temperature_result_4)          , ATTR_TYPE_FLOAT         , 0x2   , av_float            , attr_prepare_temperature_result_4   , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
