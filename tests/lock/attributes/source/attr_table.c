...
typedef struct ro_attribute {
	...
	uint8_t test_w;
	uint8_t test_x;
	uint8_t test_lock_uint8;
	int8_t test_lock_int8;
	uint16_t test_lock_uint16;
	int16_t test_lock_int16;
	uint32_t test_lock_uint32;
	int32_t test_lock_int32;
	bool test_lock_bool;
	char test_lock_string[10 + 1];
	uint8_t test_lock_byte_array[10];
	/* pyend */
} ro_attribute_t;
...
static const ro_attribute_t DEFAULT_RO_ATTRIBUTE_VALUES = {
	...
	.test_lock_uint32 = 29,
	.test_lock_int32 = 30,
	.test_lock_bool = false,
	.test_lock_string = "28",
	.test_lock_byte_array = { 0xFA, 0xFF, 0xCC, 0x22, 0x00, 0x18, 0x32, 0x74, 0xA2, 0xBC }
	/* pyend */
};
...
const struct attr_table_entry ATTR_TABLE[ATTR_TABLE_SIZE] = {
	...
	[30 ] = { 30 , RO_ATTRX(test_lock_uint8)               , ATTR_TYPE_U8            , n, y, y, y, n, n, 0, av_uint8            , NULL                                , .min.ux = 0         , .max.ux = 255        },
	[31 ] = { 31 , RO_ATTRX(test_lock_int8)                , ATTR_TYPE_S8            , n, y, y, y, n, n, 0, av_int8             , NULL                                , .min.sx = -127      , .max.sx = 127        },
	[32 ] = { 32 , RO_ATTRX(test_lock_uint16)              , ATTR_TYPE_U16           , n, y, y, y, n, n, 0, av_uint16           , NULL                                , .min.ux = 0         , .max.ux = 65535      },
	[33 ] = { 33 , RO_ATTRX(test_lock_int16)               , ATTR_TYPE_S16           , n, y, y, y, n, n, 0, av_int16            , NULL                                , .min.sx = -32767    , .max.sx = 32767      },
	[34 ] = { 34 , RO_ATTRX(test_lock_uint32)              , ATTR_TYPE_U32           , n, y, y, y, n, n, 0, av_uint32           , NULL                                , .min.ux = 0         , .max.ux = 4294967295 },
	[35 ] = { 35 , RO_ATTRX(test_lock_int32)               , ATTR_TYPE_S32           , n, y, y, y, n, n, 0, av_int32            , NULL                                , .min.sx = -2147483648, .max.sx = 2147483647 },
	[36 ] = { 36 , RO_ATTRX(test_lock_bool)                , ATTR_TYPE_BOOL          , n, y, y, y, n, n, 0, av_bool             , NULL                                , .min.ux = 0         , .max.ux = 0          },
	[37 ] = { 37 , RO_ATTRS(test_lock_string)              , ATTR_TYPE_STRING        , n, y, y, y, n, n, 0, av_string           , NULL                                , .min.ux = 0         , .max.ux = 10         },
	[38 ] = { 38 , RO_ATTRX(test_lock_byte_array)          , ATTR_TYPE_BYTE_ARRAY    , n, y, y, y, n, n, 0, av_array            , NULL                                , .min.ux = 0         , .max.ux = 0          },
	[39 ] = { 50 , RW_ATTRS(load_path)                     , ATTR_TYPE_STRING        , y, y, y, n, n, n, 0, av_string           , NULL                                , .min.ux = 0         , .max.ux = 32         },
	[40 ] = { 51 , RW_ATTRS(dump_path)                     , ATTR_TYPE_STRING        , y, y, y, n, n, n, 0, av_string           , NULL                                , .min.ux = 0         , .max.ux = 32         }
	/* pyend */
};
